(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(isTrue,x){
      if (!isTrue) return false;
      if (iterator(x)) return true;
      return false;
    }, true);
  ...
  _.some = function(collection, iterator) {
    ...
    //I don't like this but it uses every()...
    if (arguments.length===1) iterator = _.identity;
...
*/
  ...
  _.extend = function(obj) {
    ...
    return _.reduce(arguments, function(flat, current){
